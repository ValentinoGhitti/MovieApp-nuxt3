      ...
      <div class="flex flex-col col-span-3">
        ...
        <div class="flex">
          <div
            ...
            class="px-4 py-2 bg-gray-200 text-gray-200 rounded mr-2 mb-2"
          >
            {{ genre.name }}
          </div>
        </div>
        <div class="text-lg my-2">Release date:A</div>
        <div class="text-lg my-2">Duration date: {{ data?.runtime }}</div>
